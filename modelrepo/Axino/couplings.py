...
GC_745 = Coupling(name = 'GC_745',
                  value = '-((aS**2*complex(0,1)*Mgo*cmath.log(fpq))/(fpq*cmath.pi**2*cmath.sqrt(2))) + (aS**2*complex(0,1)*Mgo*cmath.log(Mgo))/(fpq*cmath.pi**2*cmath.sqrt(2))',
                  order = {'QCD':4})
